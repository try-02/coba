...
class CheckoutServiceIntegrationTest {
    ...
    private val qtyP1 = 2L
    private val hargaP2 = 7_500L
    private val qtyP2 = 1L
    ...
    private suspend fun seedStandar(): Fixture {
        ...
        listOf("Kopi Susu" to hargaP1, "Gula Pasir" to hargaP2).forEachIndexed { i, (nama, harga) ->
            ...
            db.persediaanDao().insert(PersediaanEntity(produkId = id, jumlah = 1_000, jumlahRusak = 0, diperbaruiPada = now))
        }
        ...
        return Fixture(cartId, cashierId, shiftId, produkIds)
    }
    ...
    fun kegagalanDiTengahTransaksiMengembalikanSemuaTulisan() = runBlocking {
        val f = seedStandar()
        // Benturan sengaja: nomor ini sudah dipakai transaksi lain -> insert gagal
        // SETELAH sebagian operasi lain sempat "ditulis" dalam rencana eksekusi.
