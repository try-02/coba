...
import com.pos.offline.data.model.JenisPergerakanKas

@Entity(tableName = "pergerakan_kas", foreignKeys = [
...
], indices = [Index("shift_id"), Index("transaksi_id"), Index("pengembalian_id"), Index("dibuat_pada")])
data class PergerakanKasEntity(
    @PrimaryKey(autoGenerate = true) val id: Long = 0,
    @ColumnInfo(name = "shift_id") val shiftId: Long,
    val jenis: JenisPergerakanKas,
    @ColumnInfo(name = "jumlah_delta") val jumlahDelta: Long,
