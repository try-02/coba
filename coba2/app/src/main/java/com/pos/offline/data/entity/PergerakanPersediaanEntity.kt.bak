...
@Entity(tableName = "pergerakan_persediaan", foreignKeys = [
    ForeignKey(entity = ProdukEntity::class, parentColumns = ["id"], childColumns = ["produk_id"], onDelete = ForeignKey.RESTRICT),
    ...
    ForeignKey(entity = ItemPengembalianEntity::class, parentColumns = ["id"], childColumns = ["item_pengembalian_id"], onDelete = ForeignKey.RESTRICT),
    ForeignKey(entity = ShiftEntity::class, parentColumns = ["id"], childColumns = ["shift_id"], onDelete = ForeignKey.RESTRICT),
], indices = [
    Index(value = ["produk_id", "dibuat_pada", "id"]), Index("transaksi_id"), Index("item_transaksi_id"),
    Index("pengembalian_id"), Index("item_pengembalian_id"), Index("shift_id"),
])
data class PergerakanPersediaanEntity(
    ...
    @ColumnInfo(name = "perubahan_jumlah") val perubahanJumlah: Long,
    @ColumnInfo(name = "perubahan_jumlah_rusak") val perubahanJumlahRusak: Long,
    @ColumnInfo(name = "saldo_jumlah_sebelum") val saldoJumlahSebelum: Long,
    @ColumnInfo(name = "saldo_jumlah_setelah") val saldoJumlahSetelah: Long,
    @ColumnInfo(name = "saldo_rusak_sebelum") val saldoRusakSebelum: Long,
    @ColumnInfo(name = "saldo_rusak_setelah") val saldoRusakSetelah: Long,
    ...
    @ColumnInfo(name = "item_pengembalian_id") val itemPengembalianId: Long?,
