...
class OfflineCartRepository(private val carts: KeranjangDao, private val items: ItemKeranjangDao) : CartRepository {
    ...
    override suspend fun changeQuantity(cartId: Long, productId: Long, delta: Long, now: Long) = items.changeQuantity(cartId, productId, delta, now)
