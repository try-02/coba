...
fun BluetoothPickerDialog(
    ...
    val onSelectBondedDevice: (BluetoothDeviceInfo) -> Unit = remember(viewModel) {
        { device ->
            viewModel.selectBondedDevice(device)
            onDismiss()
        }
    }
    val onToggleDiscovery: () -> Unit = remember(viewModel) {
        {
    ...
    BluetoothPickerDialogContent(
        ...
        onRequestPermission = { permissionLauncher.launch(PermissionUtils.requiredBluetoothPermissions()) },
        onEnableBluetooth = { enableBtLauncher.launch(Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE)) },
        onSelectBondedDevice = onSelectBondedDevice,
 ...
 */
@Composable
fun BluetoothPickerDialogContent(
    state: BluetoothUiState,
    permissionState: PermissionUtils.BluetoothPermissionState,
    btEnabled: Boolean,
    onDismiss: () -> Unit,
    onOpenAppSettings: () -> Unit,
    onRequestPermission: () -> Unit,
    onEnableBluetooth: () -> Unit,
    onSelectBondedDevice: (BluetoothDeviceInfo) -> Unit,
    onToggleDiscovery: () -> Unit,
    onRequestPairing: (BluetoothDeviceInfo) -> Unit,
                    ...
                    PermissionUtils.BluetoothPermissionState.Granted -> {
                        if (!btEnabled) {
                            ...
                            Row(
                                ...
                                TextButton(onClick = onToggleDiscovery) {
                                    Text(
